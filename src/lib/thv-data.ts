...
export const SAVINGS_PLANS = [
  {
    ...
    payout: "Capital + 20% interest at maturity",
    example: "Save ₦100,000 → Receive ₦120,000",
  ...
  },
  {
    ...
    payout: "Total contribution + 25% interest",
    example: "Save ₦20,000/mo for 5 months → Receive ₦125,000",
...
export const FAQS = [
  ...
  { q: "Do you offer cash savings plans?", a: "Yes — Plan A (6 months, 20%) and Plan B (12 months, 25%) cash savings options are available." },
