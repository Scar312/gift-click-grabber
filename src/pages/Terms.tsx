...
const sections = [
  ...
  { t: "5. Interest Rate (Savings Plan)", b: "Savings participants earn 30% – 45% interest over the agreed term, subject to compliance with all payment plan schedules. Early withdrawal before maturity may result in a reduction or forfeiture of accumulated interest." },
